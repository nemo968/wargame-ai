...
interface HexGridProps {
  ...
  setupHighlight?: { splitCol: number; axisSetupSplitCol?: number; side: 'allied' | 'axis'; maps?: number[] } | null
  // Op Fire target hex
                ...
                ? setupHighlight.maps && setupHighlight.maps.length > 0
                  ...
                  : (orientation === 'pointy-top'
                      ? (setupHighlight.side === 'allied'
                          ...
                          : hex.row <= (setupHighlight.axisSetupSplitCol ?? setupHighlight.splitCol))
                      : (setupHighlight.side === 'allied'
                          ? hex.col <= setupHighlight.splitCol
                          : hex.col > (setupHighlight.axisSetupSplitCol ?? setupHighlight.splitCol)))
                : false}
